...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"ابتدا",sLast:"انتها",sNext:"بعدی",sPrevious:"قبلی"},sEmptyTable:"No data available in table",sInfo:"نمایش _START_ تا _END_ از _TOTAL_ نفر",sInfoEmpty:"نمایش 0 تا 0 از 0 نفر",sInfoFiltered:"(فیلتر شده _MAX_ نفر)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"نمایش _MENU_ تایی",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"جستجو:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"موردی پیدا نشد"},oSearch:k.extend({},u.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};G(u.defaults);u.defaults.column={aDataSort:null,
