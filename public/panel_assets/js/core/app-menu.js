...
(function (window, document, $) {
	...
	$.app.menu = {
		...
		change: function (defMenu, menuIconColorsObj) {
			...
			// Initialize drill down menu for vertical master, for horizontal master drilldown menu is intitialized in changemenu function
		...
		changeMenu: function (screen) {
			...
			if (screen === 'xl') {
				...
				// Intitialize drill down menu for horizontal master
				// --------------------------------------------------
