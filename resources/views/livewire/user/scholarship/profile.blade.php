                        ...
                        <div class="row">
                            <div class="col-md-4 px-1">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control " placeholder="نام را وارد کنید"  wire:model.lazy="User.fname"   />
                                    @error('User.fname')
                                        <p class="text-danger">
                            ...
                            <div class="col-md-4 px-1">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control " placeholder="نام خانوادگی را وارد کنید" wire:model.lazy="User.lname"  required />
                                    @error('User.lname')
                                    <p class="text-danger">
                                        <strong>{{ $message }}</strong>
                                    </p>
