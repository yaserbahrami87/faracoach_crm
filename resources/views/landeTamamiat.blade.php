        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div >
                    ...
                    <p class="d-inline font-weight-bold"> مهمترین عامل برای ساختن پرسنال برند </p>
                    <p class="d-inline" >( برند شخصی ) و حتی برند سازمانی،</p>
                    <p class="font-weight-bold d-inline">داشتن تمامیت</p>
                    <p class="d-inline">و به کارگیری دستورات «قانون تمامیت » است؟</p>
                </div>
                ...
                <p>ومی از تمام و کمال بودن است. اتوموبیلی را فرض کنید که چرخ ندارد، این اتوموبیل هرگز کارکرد درستی نخواهد داشت. حتی جزئی تر از آن، اتوموبیلی را تصور کنید که یک برف پاک کن ساده را ندارد ، باز هم یک اتوموبیل تمام و کمال نخواهد بود و در شرایط بحرانی ممکن است باعث بروز خسارت های جدی به ما شود.                        <br/>
                </p>
