                    ...
                    <div class="col-12">
                        <div class="row px-1">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>وضعیت</label>
                                    <input type="text" class="form-control"  value="@if(!is_null($item->userType))  @if(!is_null($item->userType['type'])) {{$item->userType['type']}} @endif @endif" name="state" disabled="disabled"  />
