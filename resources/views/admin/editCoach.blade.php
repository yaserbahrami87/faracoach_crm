            ...
            <div class="card-body">
                <form method="post" action="/admin/coach/{{$coach->id}}" >
                    ...
                    <div class="form-group">
                        <textarea class="form-control textarea @error('education_background') is-invalid @enderror " name="education_background" id="education_background" rows="3">{{$coach->education_background}}</textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="fi">قیمت هر ساعت جلسه (تومان) <span class="text-danger">*</span></label>
                ...
                @foreach($messages as $item)
                    <div class="form-group @if($item->user_id_send==Auth::user()->id) bg-success @else bg-warning @endif">
