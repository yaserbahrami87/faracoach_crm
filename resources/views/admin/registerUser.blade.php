...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header border-bottom pb-1 bg-light">{{ __('ثبت نام کاربر جدید') }}</div>
                        ...
                        <form method="POST" action="/admin/register">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="tel" dir="ltr" type="text" class="form-control @error('tel') is-invalid @enderror"  value="{{ old('tel') }}" required autocomplete="tel">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="gettingknow_parent" name="gettingknow_parent"   class="form-control p-0" @error('gettingknow_parent') is-invalid @enderror >
