...
<div class="card">
    <div class="card-header bg-info">
        <a class="row border-bottom" type="button" data-toggle="collapse" data-target="#amoozeshAdmin" aria-expanded="false" aria-controls="amoozeshAdmin">
            <div class="col-8">
                <h6 class="card-title m-0">گروه های آموزشی</h6>
            </div>
            <div class="col-4 text-right dark">
                <svg  class="text-dark" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-easel-fill" viewBox="0 0 16 16">
