                ...
                @if($booking->start_date<=$dateNow)
                    <form method="post" action="/panel/reserve/{{$booking->id}}/update" >
                        ...
                        <div class="form-group">
                                ...
                                <select class="form-control" id="status" name="status" @if(!is_null($booking->result_coach)) disabled  @endif>
                                    <option disabled selected>انتخاب کنید</option>
                                    <option value="3" @if($booking->status==3) selected  @endif >برگزار شد</option>
                                    <option value="4" @if($booking->status==4) selected  @endif >کنسل شد</option>
                                </select>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-group border-bottom">
                        ...
                        @else
                            @for($i=1;$i<=5;$i++)
                                <input name="expectations" type="radio" class="star-demo" value="{{$i}}" disabled @if($i==$booking->feedback->expectations) checked @endif disabled/>
                            @endfor
                        @endif
                    </div>
                    <div class="form-group border-bottom">
                    ...
                    <div class="form-group border-bottom">
                        ...
                        @else
                            @for($i=1;$i<=5;$i++)
                                <input name="homework" type="radio" class="star-demo" value="{{$i}}" disabled @if($i==$booking->feedback->homeworks) checked @endif disabled/>
                            @endfor
                        @endif
                    </div>
                    <div class="form-group border-bottom">
                    ...
                    <div class="form-group border-bottom">
                        ...
                        <textarea class="form-control" id="self_awareness" rows="3" name="self_awareness" disabled >@if(old('self_awareness')) {{old('self_awareness')}} @elseif(!is_null($booking->feedback)){{$booking->self_awareness}} @endif</textarea>
                    </div>
                    <div class="form-group border-bottom">
        ...
        @if($booking->start_date<$dateNow)
            <div class="card card-user">
                ...
                <div class="card-body collapse show bg-secondary-light border-secondary" id="homework" >
                    @if($booking->homeworks->count()>0)
                        @foreach($booking->homeworks as $item)
                            <div class="form-group border-bottom">
                                @if($loop->iteration==1)
                        ...
                        <form method="post" action="/panel/homework" enctype="multipart/form-data">
                            ...
                            <input type="hidden" value="{{$booking->homeworks[0]->id}}" name="homework_id_answer"/>
                            <div class="form-group">
                                <label for="text">توضیحات:*</label>
        ...
        <div class="card card-user">
            ...
            <div class="card-body collapse show bg-secondary-light border-secondary" id="infoProfile">
                <div class="row">
                    <div class="col-12">
                        <div class="media">
                            <img src="{{asset('/documents/users/'.$booking->coach->user->personal_image)}}" class="mr-3" width="100px" >
                            <div class="media-body">
                                <div class="row">
                                    <div class="col-12 col-md-6 col-sm-6 col-xl-6 col-lg-6">
                                        <h5 class="mt-0">{{$booking->coach->user->fname." ".$booking->coach->user->lname}}</h5>
                                        <p class="m-0 p-0">متولد: {{$booking->coach->user->datebirth}}</p>
                                        <p class="m-0 p-0">جنسیت: @if($booking->coach->user->sex==1) مرد @else زن @endif</p>
                                        <p class="m-0 p-0">تاهل: @if($booking->coach->user->married==0) مجرد@elseif($booking->coach->user->married==1) متاهل @endif</p>
                                        <p class="m-0 p-0">شغل: {{$booking->coach->user->job}}</p>

                                    </div>
                                    <div class="col-12 col-md-6 col-sm-6 col-xl-6 col-lg-6 pt-3" >
                                        <p class="m-0 p-0">
                                            <i class="bi bi-telephone-fill"></i>
                                            <a dir="ltr" href="tel:{{$booking->coach->user->tel}}">{{$booking->coach->user->tel}}</a>
                                        </p>
                                        <p class="m-0 p-0">
                                            <i class="bi bi-envelope-fill"></i>
                                            <a href="mail:{{$booking->coach->user->email}}">{{$booking->coach->user->email}}</a>
                                        </p>
                                        <p class="m-0 p-0">
                                            <i class="bi bi-instagram"></i>
                                            <a href="https://instagram/{{$booking->coach->user->instagram}}">{{$booking->coach->user->instagram}}</a>
                                        </p>
                                        <p class="m-0 p-0">
                                            <i class="bi bi-telegram"></i>
                                            <a href="https://telegram.org/{{$booking->coach->user->telegram}}">{{$booking->coach->user->telegram}}</a>
                                        </p>
                                        <p class="m-0 p-0">
                                            <i class="bi bi-linkedin"></i>
                                            <a href="https://www.linkedin.com/in/{{$booking->coach->user->linkedin}}">{{$booking->coach->user->linkedin}}</a>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="media-body">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6 col-sm-6 col-xl-6 col-lg-6 pt-3" >
                                        <p class="m-0 p-0 ">
                                            <i class="bi bi-telephone-fill"></i>
                                            <a dir="ltr"  href="tel:{{$booking->reserve->user->tel}}">{{$booking->reserve->user->tel}}</a>
                                        </p>
                                        <p class="m-0 p-0">
                                            <i class="bi bi-envelope-fill"></i>
