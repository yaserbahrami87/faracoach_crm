            ...
            <div class="card">
                ...
                <div class="card-body border-1 border">
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                        ...
                        <select class="form-control" name="level" @if(!is_null($scholarship->user->get_scholarshipInterview)) disabled @endif >
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                        ...
                        <select class="form-control" name="type_holding" @if(!is_null($scholarship->user->get_scholarshipInterview)) disabled @endif >
                            <option disabled selected>انتخاب کنید</option>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="cooperation" name="cooperation" rows="3" @if(!is_null($scholarship->user->get_scholarshipInterview)) disabled @endif >@if(!is_null($scholarship->user->get_scholarshipInterview)){{$scholarship->user->get_scholarshipInterview->cooperation}}@endif</textarea>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card ">
                ...
                <div class="card-body border border-1">
                    <div class="input-group mb-2 mr-sm-2">
                        ...
                        <select class="form-control" name="motivation" id="scholarship_motivation" @if(!is_null($scholarship->user->get_scholarshipInterview)) disabled @endif  >
                            <option disabled selected>انتخاب کنید</option>
                            @for($i=1;$i<=6;$i++)
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                        ...
                        <select class="form-control" name="ability" id="scholarship_ability" @if(!is_null($scholarship->user->get_scholarshipInterview)) disabled @endif >
                            <option disabled selected>انتخاب کنید</option>
                            @for($i=1;$i<=6;$i++)
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                        ...
                        <select class="form-control" name="obligation" id="scholarship_obligation" @if(!is_null($scholarship->user->get_scholarshipInterview)) disabled @endif >
                            <option disabled selected>انتخاب کنید</option>
                            @for($i=1;$i<=6;$i++)
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                        ...
                        <select class="form-control" name="impact" id="scholarship_impact" @if(!is_null($scholarship->user->get_scholarshipInterview)) disabled @endif >
                            <option disabled selected>انتخاب کنید</option>
                            @for($i=1;$i<=6;$i++)
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                        ...
                        <select class="form-control" name="validity" id="scholarship_validity" @if(!is_null($scholarship->user->get_scholarshipInterview)) disabled @endif>
                            <option disabled selected>انتخاب کنید</option>
                            @for($i=1;$i<=6;$i++)
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="3" @if(!is_null($scholarship->user->get_scholarshipInterview)) disabled @endif>@if(!is_null($scholarship->user->get_scholarshipInterview)) {{$scholarship->user->get_scholarshipInterview->description}} @endif</textarea>
                    </div>
                </div>
            </div>
        </div>
