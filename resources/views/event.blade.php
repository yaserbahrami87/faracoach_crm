...
@section('headerscript')
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.5.0/font/bootstrap-icons.css"/>ُ
                            ...
                            @if($eventReserve->count()>0 && ($event->type==2))
                                <div class="card mt-4" >
                                    <div class="card-body overflow-auto text-center">
                                        ...
                                        <small>در صورت استفاده از زوم از رمز 0000 و در صورت استفاده از اسکای روم از گزینه مهمان استفاده کنید</small>
                                    </div>
                                </div>
                            @endif
                        @endif
