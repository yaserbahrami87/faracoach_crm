            ...
            <div class=" col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <form name="demo" id="demo" method="POST" action="/panel/integrityTest" class="myBook mt-4">
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle1_2" name="vehicle1" value="2" required />
                        <label for="vehicle1_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle1_1" name="vehicle1" value="1" required />
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle2_5" name="vehicle2" value="5" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle2_2" name="vehicle2" value="2" required>
                        <label for="vehicle2_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle2_1" name="vehicle2" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle3_5" name="vehicle3" value="5" required>
                        ...
                        <input class="page-next"  type="radio" id="vehicle3_2" name="vehicle3" value="2" required>
                        <label for="vehicle3_2"> مخالفم</label><br>
                        <input class="page-next"  type="radio" id="vehicle3_1" name="vehicle3" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next"  type="radio" id="vehicle4_5" name="vehicle4" value="5" required>
                        <label for="vehicle4_5"> کاملا موافقم</label><br>
                        <input class="page-next"  type="radio" id="vehicle4_4" name="vehicle4" value="4" required>
                        ...
                        <input class="page-next"  type="radio" id="vehicle4_2" name="vehicle4" value="2" required>
                        <label for="vehicle4_2"> مخالفم</label><br>
                        <input class="page-next"  type="radio" id="vehicle4_1" name="vehicle4" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next"  type="radio" id="vehicle5_5" name="vehicle5" value="5" required>
                        <label for="vehicle5_5"> کاملا موافقم</label><br>
                        <input  class="page-next" type="radio" id="vehicle5_4" name="vehicle5" value="4" required>
                        ...
                        <input class="page-next"  type="radio" id="vehicle1" name="vehicle5" value="2" required>
                        <label for="vehicle1"> مخالفم</label><br>
                        <input class="page-next"  type="radio" id="vehicle2" name="vehicle5" value="1" required>
                    ...
                    <section >
                        <p>6- در اولین فرصتی که بتوانم از خیابان عبور کنم، عرض خیابان را طی می کنم و توجهی به چراغ، پل عابر پیاده و یا خط کشی را ندارم</p>
                            <input class="page-next"  type="radio" id="vehicle6_5" name="vehicle6" value="5" required>
                            <label for="vehicle6_5"> کاملا موافقم</label><br>
                            <input class="page-next"  type="radio" id="vehicle6_4" name="vehicle6" value="4" required>
                            ...
                            <input class="page-next"  type="radio" id="vehicle6_2" name="vehicle6" value="2" required>
                            <label for="vehicle6_2"> مخالفم</label><br>
                            <input class="page-next"  type="radio" id="vehicle6_1" name="vehicle6" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next"  type="radio" id="vehicle7_5" name="vehicle7" value="5" required>
                        <label for="vehicle7_5"> کاملا موافقم</label><br>
                        <input class="page-next"  type="radio" id="vehicle7_4" name="vehicle7" value="4" required>
                        ...
                        <input  class="page-next" type="radio" id="vehicle7_2" name="vehicle7" value="2" required>
                        <label for="vehicle7_2"> مخالفم</label><br>
                        <input class="page-next"  type="radio" id="vehicle7_1" name="vehicle7" value="1" required>
                    ...
                    <section >
                        ...
                        <input  class="page-next" type="radio" id="vehicle8_5" name="vehicle8" value="5" required>
                        ...
                        <input  class="page-next" type="radio" id="vehicle8_2" name="vehicle8" value="2" required>
                        <label for="vehicle8_2"> مخالفم</label><br>
                        <input  class="page-next" type="radio" id="vehicle8_1" name="vehicle8" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next"  type="radio" id="vehicle9_5" name="vehicle9" value="5" required>
                        <label for="vehicle9_5"> کاملا موافقم</label><br>
                        <input class="page-next"  type="radio" id="vehicle9_4" name="vehicle9" value="4" required>
                        ...
                        <input  class="page-next" type="radio" id="vehicle9_2" name="vehicle9" value="2" required>
                        <label for="vehicle9_2"> مخالفم</label><br>
                        <input  class="page-next" type="radio" id="vehicle9_1" name="vehicle9" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next"  type="radio" id="vehicle10_5" name="vehicle10" value="5" required>
                        <label for="vehicle10_5"> کاملا موافقم</label><br>
                        <input class="page-next"  type="radio" id="vehicle10_4" name="vehicle10" value="4" required>
                        ...
                        <input class="page-next"  type="radio" id="vehicle10_2" name="vehicle10" value="2" required>
                        <label for="vehicle10_2"> مخالفم</label><br>
                        <input class="page-next"  type="radio" id="vehicle10_1" name="vehicle10" value="1" required>
                    ...
                    <section >
                        <p>11- مبعضی وقتها برای اینکه زودتر برسم چاره ای ندارم که قوانین راهنمائی رانندگی را ندیده بگیرم</p>
                            <input class="page-next"  type="radio" id="vehicle11_5" name="vehicle11" value="5" required>
                            <label for="vehicle11_5"> کاملا موافقم</label><br>
                            <input class="page-next"  type="radio" id="vehicle11_4" name="vehicle11" value="4" required>
                            ...
                            <input  class="page-next" type="radio" id="vehicle11_2" name="vehicle11" value="2" required>
                            <label for="vehicle11_2"> مخالفم</label><br>
                            <input  class="page-next" type="radio" id="vehicle11_1" name="vehicle11" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next"  type="radio" id="vehicle12_5" name="vehicle12" value="5" required>
                        <label for="vehicle12_5"> کاملا موافقم</label><br>
                        <input class="page-next"  type="radio" id="vehicle12_4" name="vehicle12" value="4"required >
                        ...
                        <input class="page-next"  type="radio" id="vehicle12_2" name="vehicle12" value="2" required>
                        <label for="vehicle12_2"> مخالفم</label><br>
                        <input class="page-next"  type="radio" id="vehicle12_1" name="vehicle12" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next"  type="radio" id="vehicle13_5" name="vehicle13" value="5" required >
                        <label for="vehicle13_5"> کاملا موافقم</label><br>
                        <input class="page-next"  type="radio" id="vehicle13_4" name="vehicle13" value="4" required >
                        ...
                        <input class="page-next"  type="radio" id="vehicle13_2" name="vehicle13" value="2" required >
                        <label for="vehicle13_2"> مخالفم</label><br>
                        <input  class="page-next" type="radio" id="vehicle13_1" name="vehicle13" value="1" required >
                    ...
                    <section >
                        ...
                        <input  class="page-next" type="radio" id="vehicle14_5" name="vehicle14" value="5" required >
                        ...
                        <input class="page-next"  type="radio" id="vehicle14_2" name="vehicle14" value="2" required >
                        <label for="vehicle14_2"> مخالفم</label><br>
                        <input class="page-next"  type="radio" id="vehicle14_1" name="vehicle14" value="1" required >
                    ...
                    <section >
                        ...
                        <input class="page-next"  type="radio" id="vehicle15_5" name="vehicle15" value="5" required >
                        ...
                        <input class="page-next"  type="radio" id="vehicle15_2" name="vehicle15" value="2" required>
                        <label for="vehicle15_2"> مخالفم</label><br>
                        <input class="page-next"  type="radio" id="vehicle15_1" name="vehicle15" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next"  type="radio" id="vehicle16_5" name="vehicle16" value="5" required>
                        <label for="vehicle16_5"> کاملا موافقم</label><br>
                        <input class="page-next"  type="radio" id="vehicle16_4" name="vehicle16" value="4" required>
                        ...
                        <input class="page-next"  type="radio" id="vehicle16_2" name="vehicle16" value="2" required>
                        <label for="vehicle16_2"> مخالفم</label><br>
                        <input class="page-next"  type="radio" id="vehicle16_1" name="vehicle16" value="1" required>
                    ...
                    <section >
                        ...
                        <input  class="page-next" type="radio" id="vehicle17_5" name="vehicle17" value="5" required>
                        <label for="vehicle17_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle17_4" name="vehicle17" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle17_2" name="vehicle17" value="2" required>
                        <label for="vehicle17_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle17_1" name="vehicle17" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle18_5" name="vehicle18" value="5" required>
                        <label for="vehicle18_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle18_4" name="vehicle18" value="4" required>
                        ...
                        <input class="page-next"  type="radio" id="vehicle18_2" name="vehicle18" value="2" required>
                        <label for="vehicle18_2"> مخالفم</label><br>
                        <input class="page-next"  type="radio" id="vehicle18_1" name="vehicle18" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle19_5" name="vehicle19" value="5" required>
                        <label for="vehicle19_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle19_4" name="vehicle19" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle19_2" name="vehicle19" value="2" required>
                        <label for="vehicle19_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle19_1" name="vehicle19" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle20_5" name="vehicle20" value="5" required>
                        <label for="vehicle20_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle20_4" name="vehicle20" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle20_2" name="vehicle20" value="2" required>
                        <label for="vehicle20_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle20_1" name="vehicle20" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle21_5" name="vehicle21" value="5" required>
                        <label for="vehicle21_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle21_4" name="vehicle21" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle21_2" name="vehicle21" value="2" required>
                        <label for="vehicle21_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle21_1" name="vehicle21" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle22_5" name="vehicle22" value="5" required>
                        <label for="vehicle22_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle22_4" name="vehicle22" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle22_2" name="vehicle22" value="2" required>
                        <label for="vehicle22_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle22_1" name="vehicle22" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle23_5" name="vehicle23" value="5" required>
                        <label for="vehicle23_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle23_4" name="vehicle23" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle23_2" name="vehicle23" value="2" required>
                        <label for="vehicle23_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle23_1" name="vehicle23" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle24_5" name="vehicle24" value="5" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle24_2" name="vehicle24" value="2" required>
                        <label for="vehicle24_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle24_1" name="vehicle24" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle25_5" name="vehicle25" value="5" required>
                        <label for="vehicle25_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle25_4" name="vehicle25" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle25_2" name="vehicle25" value="2" required>
                        <label for="vehicle25_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle25_1" name="vehicle25" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle26_5" name="vehicle26" value="5" required>
                        <label for="vehicle26_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle26_4" name="vehicle26" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle26_2" name="vehicle26" value="2" required>
                        <label for="vehicle26_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle26_1" name="vehicle26" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle27_5" name="vehicle27" value="5" required>
                        <label for="vehicle27_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle27_4" name="vehicle27" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle27_2" name="vehicle27" value="2" required>
                        <label for="vehicle27_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle27_1" name="vehicle27" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle28_5" name="vehicle28" value="5" required>
                        <label for="vehicle28_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle28_4" name="vehicle28" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle28_2" name="vehicle28" value="2" required>
                        <label for="vehicle28_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle28_1" name="vehicle28" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle29_5" name="vehicle29" value="5" required>
                        <label for="vehicle29_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle29_4" name="vehicle29" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle29_2" name="vehicle29" value="2" required>
                        <label for="vehicle29_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle29_1" name="vehicle29" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle30_5" name="vehicle30" value="5" required>
                        <label for="vehicle30_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle30_4" name="vehicle30" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle30_2" name="vehicle30" value="2" required>
                        <label for="vehicle30_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle30_1" name="vehicle30" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle31_5" name="vehicle31" value="5" required>
                        <label for="vehicle31_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle31_4" name="vehicle31" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle31_2" name="vehicle31" value="2" required>
                        <label for="vehicle31_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle31_1" name="vehicle31" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle32_5" name="vehicle32" value="5" required>
                        <label for="vehicle32_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle32_4" name="vehicle32" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle32_2" name="vehicle32" value="2" required>
                        <label for="vehicle32_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle32_1" name="vehicle32" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle33_5" name="vehicle33" value="5" required>
                        <label for="vehicle33_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle33_4" name="vehicle33" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle33_2" name="vehicle33" value="2" required>
                        <label for="vehicle33_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle33_1" name="vehicle33" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle34_5" name="vehicle34" value="5" required>
                        <label for="vehicle34_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle34_4" name="vehicle34" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle34_2" name="vehicle34" value="2" required>
                        <label for="vehicle34_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle34_1" name="vehicle34" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle35_5" name="vehicle35" value="5" required>
                        <label for="vehicle35_5"> کاملا موافقم</label><br />
                        <input class="page-next" type="radio" id="vehicle35_4" name="vehicle35" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle35_2" name="vehicle35" value="2" required>
                        <label for="vehicle35_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle35_1" name="vehicle35" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle36_5" name="vehicle36" value="5" required>
                        <label for="vehicle36_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle36_4" name="vehicle36" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle36_2" name="vehicle36" value="2" required>
                        <label for="vehicle36_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle36_1" name="vehicle36" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle37_5" name="vehicle37" value="5" required>
                        <label for="vehicle37_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle37_4" name="vehicle37" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle37_2" name="vehicle37" value="2" required>
                        <label for="vehicle37_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle37_1" name="vehicle37" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle38_5" name="vehicle38" value="5" required>
                        <label for="vehicle38_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle38_4" name="vehicle38" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle38_2" name="vehicle38" value="2" required>
                        <label for="vehicle38_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle38_1" name="vehicle38" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle39_5" name="vehicle39" value="5" required>
                        <label for="vehicle39_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle39_4" name="vehicle39" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle39_2" name="vehicle39" value="2" required>
                        <label for="vehicle39_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle39_1" name="vehicle39" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle40_5" name="vehicle40" value="5" required>
                        <label for="vehicle40_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle40_4" name="vehicle40" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle40_2" name="vehicle40" value="2" required>
                        <label for="vehicle40_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle40_1" name="vehicle40" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle41_5" name="vehicle41" value="5" required>
                        <label for="vehicle41_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle41_4" name="vehicle41" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle41_2" name="vehicle41" value="2" required>
                        <label for="vehicle41_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle41_1" name="vehicle41" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle42_5" name="vehicle42" value="5" required>
                        <label for="vehicle42_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle42_4" name="vehicle42" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle42_2" name="vehicle42" value="2" required>
                        <label for="vehicle42_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle42_1" name="vehicle42" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle43_5" name="vehicle43" value="5" required>
                        <label for="vehicle43_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle43_4" name="vehicle43" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle43_2" name="vehicle43" value="2" required>
                        <label for="vehicle43_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle43_1" name="vehicle43" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle44_5" name="vehicle44" value="5" required>
                        <label for="vehicle44_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle44_4" name="vehicle44" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle44_2" name="vehicle44" value="2" required>
                        <label for="vehicle44_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle44_1" name="vehicle44" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle45_5" name="vehicle45" value="5" required>
                        <label for="vehicle45_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle45_4" name="vehicle45" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle45_2" name="vehicle45" value="2" required>
                        <label for="vehicle45_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle45_1" name="vehicle45" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle46_5" name="vehicle46" value="5" required>
                        <label for="vehicle46_5"> کاملا موافقم</label><br>
                        <input class="page-next"type="radio" id="vehicle46_4" name="vehicle46" value="4" required>
                        ...
                        <input class="page-next"type="radio" id="vehicle46_2" name="vehicle46" value="2" required>
                        <label for="vehicle46_2"> مخالفم</label><br>
                        <input class="page-next"type="radio" id="vehicle46_1" name="vehicle46" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next"type="radio" id="vehicle47_5" name="vehicle47" value="5" required>
                        <label for="vehicle47_5"> کاملا موافقم</label><br>
                        <input class="page-next"type="radio" id="vehicle47_4" name="vehicle47" value="4" required>
                        ...
                        <input class="page-next"type="radio" id="vehicle47_2" name="vehicle47" value="2" required>
                        <label for="vehicle47_2"> مخالفم</label><br>
                        <input class="page-next"type="radio" id="vehicle47_1" name="vehicle47" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next"type="radio" id="vehicle48_5" name="vehicle48" value="5" required>
                        <label for="vehicle48_5"> کاملا موافقم</label><br>
                        <input class="page-next"type="radio" id="vehicle48_4" name="vehicle48" value="4" required>
                        ...
                        <input class="page-next"type="radio" id="vehicle48_2" name="vehicle48" value="2" required>
                        <label for="vehicle48_2"> مخالفم</label><br>
                        <input class="page-next"type="radio" id="vehicle48_1" name="vehicle48" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle49_5" name="vehicle49" value="5" required>
                        <label for="vehicle49_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle49_4" name="vehicle49" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle49_2" name="vehicle49" value="2" required>
                        <label for="vehicle49_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle49_1" name="vehicle49" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next" type="radio" id="vehicle50_5" name="vehicle50" value="5" required>
                        <label for="vehicle50_5"> کاملا موافقم</label><br>
                        <input class="page-next" type="radio" id="vehicle50_4" name="vehicle50" value="4" required>
                        ...
                        <input class="page-next" type="radio" id="vehicle50_2" name="vehicle50" value="2" required>
                        <label for="vehicle50_2"> مخالفم</label><br>
                        <input class="page-next" type="radio" id="vehicle50_1" name="vehicle50" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next"type="radio" id="vehicle51_5" name="vehicle51" value="5" required>
                        <label for="vehicle51_5"> کاملا موافقم</label><br>
                        <input class="page-next"type="radio" id="vehicle51_4" name="vehicle51" value="4" required>
                        ...
                        <input class="page-next"type="radio" id="vehicle51_2" name="vehicle51" value="2" required>
                        <label for="vehicle51_2"> مخالفم</label><br>
                        <input class="page-next"type="radio" id="vehicle51_1" name="vehicle51" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next"type="radio" id="vehicle52_5" name="vehicle52" value="5" required>
                        <label for="vehicle52_5"> کاملا موافقم</label><br>
                        <input class="page-next"type="radio" id="vehicle52_4" name="vehicle52" value="4" required>
                        ...
                        <input class="page-next"type="radio" id="vehicle52_2" name="vehicle52" value="2" required>
                        <label for="vehicle52_2"> مخالفم</label><br>
                        <input class="page-next"type="radio" id="vehicle52_1" name="vehicle52" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next"type="radio" id="vehicle53_5" name="vehicle53" value="5" required>
                        <label for="vehicle53_5"> کاملا موافقم</label><br>
                        <input class="page-next"type="radio" id="vehicle53_4" name="vehicle53" value="4" required>
                        ...
                        <input class="page-next"type="radio" id="vehicle53_2" name="vehicle53" value="2" required>
                        <label for="vehicle53_2"> مخالفم</label><br>
                        <input class="page-next"type="radio" id="vehicle53_1" name="vehicle53" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next"type="radio" id="vehicle54_5" name="vehicle54" value="5" required>
                        <label for="vehicle54_5"> کاملا موافقم</label><br>
                        <input class="page-next"type="radio" id="vehicle54_4" name="vehicle54" value="4" required>
                        ...
                        <input class="page-next"type="radio" id="vehicle54_2" name="vehicle54" value="2" required>
                        <label for="vehicle54_2"> مخالفم</label><br>
                        <input class="page-next"type="radio" id="vehicle54_1" name="vehicle54" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next"type="radio" id="vehicle55_5" name="vehicle55" value="5" required>
                        <label for="vehicle55_5"> کاملا موافقم</label><br>
                        <input class="page-next"type="radio" id="vehicle55_4" name="vehicle55" value="4" required>
                        ...
                        <input class="page-next"type="radio" id="vehicle55_2" name="vehicle55" value="2" required>
                        <label for="vehicle55_2"> مخالفم</label><br>
                        <input class="page-next"type="radio" id="vehicle55_1" name="vehicle55" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next"type="radio" id="vehicle56_5" name="vehicle56" value="5" required>
                        <label for="vehicle56_5"> کاملا موافقم</label><br>
                        <input class="page-next"type="radio" id="vehicle56_4" name="vehicle56" value="4" required>
                        ...
                        <input class="page-next"type="radio" id="vehicle56_2" name="vehicle56" value="2" required>
                        <label for="vehicle56_2"> مخالفم</label><br>
                        <input class="page-next"type="radio" id="vehicle56_1" name="vehicle56" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next"type="radio" id="vehicle57_5" name="vehicle57" value="5" required>
                        <label for="vehicle57_5"> کاملا موافقم</label><br>
                        <input class="page-next"type="radio" id="vehicle57_4" name="vehicle57" value="4" required>
                        ...
                        <input class="page-next"type="radio" id="vehicle57_2" name="vehicle57" value="2" required>
                        <label for="vehicle57_2"> مخالفم</label><br>
                        <input class="page-next"type="radio" id="vehicle57_1" name="vehicle57" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next"type="radio" id="vehicle58_5" name="vehicle58" value="5" required>
                        <label for="vehicle58_5"> کاملا موافقم</label><br>
                        <input class="page-next"type="radio" id="vehicle58_4" name="vehicle58" value="4" required>
                        ...
                        <input class="page-next"type="radio" id="vehicle58_2" name="vehicle58" value="2" required>
                        <label for="vehicle58_2"> مخالفم</label><br>
                        <input class="page-next"type="radio" id="vehicle58_1" name="vehicle58" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next"type="radio" id="vehicle59_5" name="vehicle59" value="5" required>
                        <label for="vehicle59_5"> کاملا موافقم</label><br>
                        <input class="page-next"type="radio" id="vehicle59_4" name="vehicle59" value="4" required>
                        ...
                        <input class="page-next"type="radio" id="vehicle59_2" name="vehicle59" value="2" required>
                        <label for="vehicle59_2"> مخالفم</label><br>
                        <input class="page-next"type="radio" id="vehicle59_1" name="vehicle59" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next"type="radio" id="vehicle60_5" name="vehicle60" value="5" required>
                        <label for="vehicle60_5"> کاملا موافقم</label><br>
                        <input class="page-next"type="radio" id="vehicle60_4" name="vehicle60" value="4" required>
                        ...
                        <input class="page-next"type="radio" id="vehicle60_2" name="vehicle60" value="2" required>
                        <label for="vehicle60_2"> مخالفم</label><br>
                        <input class="page-next"type="radio" id="vehicle60_1" name="vehicle60" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next"type="radio" id="vehicle61_5" name="vehicle61" value="5" required>
                        <label for="vehicle61_5"> کاملا موافقم</label><br>
                        <input class="page-next"type="radio" id="vehicle61_4" name="vehicle61" value="4" required>
                        ...
                        <input class="page-next"type="radio" id="vehicle61_2" name="vehicle61" value="2" required>
                        <label for="vehicle61_2"> مخالفم</label><br>
                        <input class="page-next"type="radio" id="vehicle61_1" name="vehicle61" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next"type="radio" id="vehicle62_5" name="vehicle62" value="5" required>
                        <label for="vehicle62_5"> کاملا موافقم</label><br>
                        <input class="page-next"type="radio" id="vehicle62_4" name="vehicle62" value="4" required>
                        ...
                        <input class="page-next"type="radio" id="vehicle62_2" name="vehicle62" value="2" required>
                        <label for="vehicle62_2"> مخالفم</label><br>
                        <input class="page-next"type="radio" id="vehicle62_1" name="vehicle62" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next"type="radio" id="vehicle63_5" name="vehicle63" value="5" required>
                        <label for="vehicle63_5"> کاملا موافقم</label><br>
                        <input class="page-next"type="radio" id="vehicle63_4" name="vehicle63" value="4" required>
                        ...
                        <input class="page-next"type="radio" id="vehicle63_2" name="vehicle63" value="2" required>
                        <label for="vehicle63_2"> مخالفم</label><br>
                        <input class="page-next"type="radio" id="vehicle63_1" name="vehicle63" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next"type="radio" id="vehicle64_5" name="vehicle64" value="5" required>
                        <label for="vehicle64_5"> کاملا موافقم</label><br>
                        <input class="page-next"type="radio" id="vehicle64_4" name="vehicle64" value="4" required>
                        ...
                        <input class="page-next"type="radio" id="vehicle64_2" name="vehicle64" value="2" required>
                        <label for="vehicle64_2"> مخالفم</label><br>
                        <input class="page-next"type="radio" id="vehicle64_1" name="vehicle64" value="1" required>
                    ...
                    <section >
                        ...
                        <input class="page-next"type="radio" id="vehicle65_5" name="vehicle65" value="5" required>
                        <label for="vehicle65_5"> کاملا موافقم</label><br>
                        <input class="page-next"type="radio" id="vehicle65_4" name="vehicle65" value="4" required>
                        ...
                        <input class="page-next"type="radio" id="vehicle65_2" name="vehicle65" value="2" required>
                        <label for="vehicle65_2"> مخالفم</label><br>
                        <input class="page-next"type="radio" id="vehicle65_1" name="vehicle65" value="1" required>
