                    ...
                    <form method="post" action="/panel/feedbackcoach" >
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="satisfaction" id="satisfaction" @if(!is_null($booking))disabled @endif>
                                <option disabled selected>انتخاب کنید</option>
                                <option style="background-color: #c6ffb3" value="1" @if(old('satisfaction')==1) selected @elseif(!is_null($booking)&&($booking->satisfaction==1)) selected @endif>این کوچ را توصیه میکنم</option>
                                <option  style="background-color:#ffb3b3 " value="0" @if(!is_null($booking)&&($booking->satisfaction==0)) selected @endif>این کوچ را توصیه نمیکنم</option>
                            </select>
