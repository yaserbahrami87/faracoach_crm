...
<div class="container">
        <div class="row shadow" id="link">
            ...
            <div class="col-12 col-sm-7 col-md-55 col-lg-7 col-xl-7">
                <p class=" dir-rtl text-center"  id="personal_link">https://my.faracoach.com/knot/register?introduce=7259</p>
            </div>
        </div>
    <div class="row">
        <!--end col-->
        <div class="col-lg-6 col-md-6 col-12 order-1 order-md-2 mt-5">
            <div class="section-title ml-lg-5">
                ...
                <p class="text-muted mb-0">
                    لذا با توجه به اینکه ظرفیت اطلاع رسانی ما محدود است، از شما درخواست میکنیم که دوستان واجد شرایط خود را به این برنامه دعوت کنید و طبعا ما نیز از این اقدام شما قدردانی مینماییم.
                </p>
                <p class="point">
                    چنانچه فردی که معرفی میکنید و یا از طریق لینک شما ثبت نام نموده است، تمام مراحل را با موفقیت طی کند (مثلا 50 امتیاز کسب کند) ،10 درصد از امتیاز بورسیه آنها به امتیاز بورسیه شما اضافه میگردد.
                </p>
                <div class="row">
...
{{--                                        <th>Edit</th>--}}
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class="m-0 font-12">
                                                <span class="col-green font-weight-bold"> گلناز گلستانی</span>
                                            </p>
                                        </td>
...
{{--                                        </td>--}}
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class="m-0 font-12">
                                                <span class="col-green font-weight-bold"> یاسر بهرامی</span>
                                            </p>
                                        </td>
                                        <td class="align-middle">
                                            <div class="progress-text">100%</div>
                                            <div class="progress" data-height="6" style="height: 6px;">
                                                <div class="progress-bar bg-success" data-width="50%" style="width: 100%;"></div>
                                            </div>
                                        </td>
                                        <td>10</td>
{{--                                        <td>--}}
...
{{--                                        </td>--}}
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class="m-0 font-12">
                                                <span class="col-green font-weight-bold"> پوریا گنجوی</span>
                                            </p>
                                        </td>
                                        <td class="align-middle">
                                            <div class="progress-text">80%</div>
                                            <div class="progress" data-height="6" style="height: 6px;">
                                                <div class="progress-bar bg-purple" data-width="50%" style="width: 50%;"></div>
                                            </div>
                                        </td>
                                        <td>10</td>
{{--                                        <td>--}}
...
{{--                                        </td>--}}
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class="m-0 font-12">
                                                <span class="col-green font-weight-bold">علی جعفرخانی</span>
                                            </p>
                                        </td>
                                        <td class="align-middle">
                                            <div class="progress-text">90%</div>
                                            <div class="progress" data-height="6" style="height: 6px;">
                                                <div class="progress-bar bg-cyan" data-width="50%" style="width:90%;"></div>
                                            </div>
                                        </td>
                                        <td>10</td>
                                    </tr>
