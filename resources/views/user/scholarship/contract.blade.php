                  ...
                  <div class="border border-1 p-1 mb-2 mt-1 shadow-sm shadow">
                      <form method="post" action="/panel/warrany" enctype="multipart/form-data">
                          ...
                          <p></p>
                              ...
                              <b> تبصره 3:</b> حضور در کلیه جلسات الزامی است؛ چنانچه دانش‌پذیر به هر دلیلی در جلسه‌ای غیبت داشته باشد، ملزم است با اطلاع آموزشگاه در جلسه‌های جبرانی همان درس در دوره‌های دیگر شرکت نماید؛ این امتیاز فقط برای 5 جلسه غیبت برقرار است.</li>
                          <ul>
