                      ...
                      <form method="post" action="/panel/warrany" enctype="multipart/form-data">
                          ...
                          <h4 class="text-danger">7.	شرایط پرداخت شهریه:</h4>
                              <ul style="line-height: 2">
                                  ...
                                  <li>درصورت نیاز (توافق با واحد ثبت نام ، درخواست گواهینامه زودتر از موعد یا شرایط خاص ) دانش پذیر یک فقره چک ضمانت/ سفته به شماره <input type="number" name="shomare_zemanat"  /> به تاریخ <input type="text" name="tarikh_zemanat" id="tarikh_zemanat"  /> عهده بانک
                          ...
                          <p> <b>تبصره 10:</b>شرکت در آزمون پایان دوره و همچنین صدور و دریافت گواهینامه، منوط به تسویه حساب کامل دانش پذیر در دوره  های عادی و  برای دانشپذیران بورسیه ، تسویه حداقل 50 درصد  مبلغ  بورسیه می باشد؛</p>
                          <p> <b>تبصره 11:</b>چنانچه  به دانشپذیر وام صندوق شکوفایی تعلق بگیرد، در صورتحساب تسویه تهاتر بورسیه لحاظ خواهد شد.</p>
                          <hr/>
                          ...
                          <p>چنانچه در تکمیل تعهدنامه خود با مشکلی مواجه هستید لطفا این صفحه را پرینت گرفته امضا کنید و برای پشتیبان واحد ثبت نام ارسال فرمایید  <button class="btn btn-primary" onclick="window.print()">پرینت</button></p>
        ...
        <div class="alert alert-success">
            ...
            <ul style="line-height: 2">
                ...
                <li>درصورت نیاز (توافق با واحد ثبت نام ، درخواست گواهینامه زودتر از موعد یا شرایط خاص ) دانش پذیر یک فقره چک ضمانت/ سفته به شماره <b class="text-success">{{$scholarship->warrany->receipt}}</b> به تاریخ {{$scholarship->warrany->date_fa}} عهده بانک
                    <b class="text-success">{{$scholarship->warrany->bank}}</b>
                    به مبلغ
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-3">
                    <img src="{{asset('/documents/signatures/'.$scholarship->warrany->signature)}}" class="img-fluid" />
                </div>
            </div>
