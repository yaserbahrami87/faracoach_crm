...
@section ('content')
    <div class="container mt-5">
        <div class="col-12 text-justify">
            <h3 >ارزیابی گوش دادن موثر</h3>
        </div>
    </div>
    <div class="container pb-4 " id="fff">
            ...
            <div class=" col-xl-6 col-lg-6 col-md-6 col-sm-12">
                ...
                {{csrf_field()}}
                    <section >
                        ...
                        <label for="vehicle1_2"> بیشتر زمانها</label><br>
                        <input class="page-next" type="radio" id="vehicle1_1" name="vehicle1" value="4" required />
                        <label for="vehicle1_1"> همه زمانها</label><br>
                    ...
                    <section >
                        ...
                        <label for="vehicle2_2"> بیشتر زمانها</label><br>
                        <input class="page-next" type="radio" id="vehicle2_1" name="vehicle2" value="4" required>
                        <label for="vehicle2_1">همه زمانها</label><br>
                        <div class="col-12 text-center mt-3">
                            <button type="button" class="page-prev btn btn-danger col-3 ">قبلی</button>
                            <button type="button" class="page-next btn btn-primary col-3">بعدی</button>
                        </div>
                    ...
                    <section >
                        ...
                        <label for="vehicle3_2"> بیشتر زمانها</label><br>
                        <input class="page-next"  type="radio" id="vehicle3_1" name="vehicle3" value="4" required>
                        <label for="vehicle3_1">همه زمانها</label><br>
                        <div class="col-12 text-center mt-3">
                            <button type="button" class="page-prev btn btn-danger col-3 ">قبلی</button>
                            <button type="button" class="page-next btn btn-primary col-3">بعدی</button>
                        </div>
                    ...
                    <section >
                        <p>4- به ایده ها و مفاهیم اصلی صحبت های گوینده دقت میکنم.
                        </p>
                    ...
                    <section >
                        <p>5- در حین صحبت های گوینده، در ذهنم دنبال آماده کردن پاسخ نیستم.
                        </p>
                    ...
                    <section >
                        <p>6- به زبان بدن گوینده حین صحبت دقت می کنم.</p>
                    ...
                    <section >
                        <p>7- به صحبت های دیگران با ذهن باز و بدون پیش داوری گوش میدهم.</p>
                    ...
                    <section >
                        <p>9- به گوینده اطمینان می دهم که در حال گوش دادن صحبت های او هستم.
                        </p>
                    ...
                    <section >
                        <p>10- جهت تشریح و توضیح مفهوم صحبت های گوینده، سوالاتی را می پرسم.
                        </p>
                    ...
                    <section >
                        <p>11- صحبت های گوینده را خلاصه سازی میکنم و نکات مهم صحبت های او را مرور میکنم.</p>
                    ...
                    <section >
                        <p>12- به زبان بدن ام در حین گوش دادن، توجه میکنم.
                        </p>
                    ...
                    <section >
                        <p>13- اگر سخن ناخوشایندی شنیدم، آرامش خود را حفظ میکنم.</p>
                    ...
                    <section >
                        <p>14- سعی میکنم با گوینده همدلی کنم.
                        </p>
                    ...
                    <section >
                        <p>16- جریان گفت و گو را کنترل نمی کنم.</p>
                        <input class="page-next"  type="radio" id="vehicle16_5" name="vehicle16" value="0" required >
                        <label for="vehicle16_5">در هیچ زمان</label><br>
                        <input class="page-next"  type="radio" id="vehicle16_4" name="vehicle16" value="1" required>
                        <label for="vehicle16_4">به ندرت </label><br>
                        <input class="page-next"  type="radio" id="vehicle16_3" name="vehicle16" value="2" required>
                        <label for="vehicle16_3"> نیمی از زمانها</label><br/>
                        <input class="page-next"  type="radio" id="vehicle16_2" name="vehicle16" value="3" required>
                        <label for="vehicle16_2"> بیشتر زمانها</label><br>
                        <input class="page-next"  type="radio" id="vehicle16_1" name="vehicle16" value="4" required>
                        <label for="vehicle16_1"> همه زمانها</label><br>
                        <div class="col-12 text-center mt-3">
                            <button type="button" class="page-prev btn btn-danger col-3 ">قبلی</button>
                            <button type="button" class="page-next btn btn-primary col-3">بعدی</button>
                        </div>
                    ...
                    <section >
                        <p>17- در لحظه واکنش نشان می دهم.</p>
                        <input class="page-next"  type="radio" id="vehicle17_5" name="vehicle17" value="0" required >
                        <label for="vehicle17_5">در هیچ زمان</label><br>
                        <input class="page-next"  type="radio" id="vehicle17_4" name="vehicle17" value="1" required>
                        <label for="vehicle17_4">به ندرت </label><br>
                        <input class="page-next"  type="radio" id="vehicle17_3" name="vehicle17" value="2" required>
                        <label for="vehicle17_3"> نیمی از زمانها</label><br/>
                        <input class="page-next"  type="radio" id="vehicle17_2" name="vehicle17" value="3" required>
                        <label for="vehicle17_2"> بیشتر زمانها</label><br>
                        <input class="page-next"  type="radio" id="vehicle17_1" name="vehicle17" value="4" required>
                        <label for="vehicle17_1"> همه زمانها</label><br>
                        <div class="col-12 text-center mt-3">
                            <button type="button" class="page-prev btn btn-danger col-3 ">قبلی</button>
                            <button type="button" class="page-next btn btn-primary col-3">بعدی</button>
                        </div>
                    ...
                    <section >
                        <p>18- در مکالمات دنبال نصیحت کردن و نتیجه گیری نیستم.</p>
                        <input class="page-next"  type="radio" id="vehicle18_5" name="vehicle18" value="0" required >
                        <label for="vehicle18_5">در هیچ زمان</label><br>
                        <input class="page-next"  type="radio" id="vehicle18_4" name="vehicle18" value="1" required>
                        <label for="vehicle18_4">به ندرت </label><br>
                        <input class="page-next"  type="radio" id="vehicle15_3" name="vehicle18" value="2" required>
                        <label for="vehicle18_3"> نیمی از زمانها</label><br/>
                        <input class="page-next"  type="radio" id="vehicle18_2" name="vehicle18" value="3" required>
                        <label for="vehicle18_2"> بیشتر زمانها</label><br>
                        <input class="page-next"  type="radio" id="vehicle18_1" name="vehicle18" value="4" required>
                        <label for="vehicle18_1"> همه زمانها</label><br>
                        <div class="col-12 text-center mt-3">
                            <button type="button" class="page-prev btn btn-danger col-3 ">قبلی</button>
                            <button type="button" class="page-next btn btn-primary col-3">بعدی</button>
                        </div>
                    ...
                    <section >
                        <p>19- در صورت نداشتن شرایط مناسب برای گوش دادن به سخنان گوینده، از او عذر خواهی میکنم.</p>
                        <input class="page-next"  type="radio" id="vehicle19_5" name="vehicle19" value="0" required >
                        <label for="vehicle19_5">در هیچ زمان</label><br>
                        <input class="page-next"  type="radio" id="vehicle19_4" name="vehicle19" value="1" required>
                        <label for="vehicle19_4">به ندرت </label><br>
                        <input class="page-next"  type="radio" id="vehicle19_3" name="vehicle19" value="2" required>
                        <label for="vehicle19_3"> نیمی از زمانها</label><br/>
                        <input class="page-next"  type="radio" id="vehicle19_2" name="vehicle19" value="3" required>
                        <label for="vehicle19_2"> بیشتر زمانها</label><br>
                        <input class="page-next"  type="radio" id="vehicle19_1" name="vehicle19" value="4" required>
                        <label for="vehicle19_1"> همه زمانها</label><br>
                        <div class="col-12 text-center mt-3">
                            <button type="button" class="page-prev btn btn-danger col-3 ">قبلی</button>
                            <button type="button" class="page-next btn btn-primary col-3">بعدی</button>
                        </div>
                    ...
                    <section >
                        <p>20- بیشتر از آنکه بگویم، گوش میدهم.</p>
                        <input class="page-next"  type="radio" id="vehicle20_5" name="vehicle20" value="0" required >
                        <label for="vehicle20_5">در هیچ زمان</label><br>
                        <input class="page-next"  type="radio" id="vehicle20_4" name="vehicle20" value="1" required>
                        <label for="vehicle20_4">به ندرت </label><br>
                        <input class="page-next"  type="radio" id="vehicle20_3" name="vehicle20" value="2" required>
                        <label for="vehicle20_3"> نیمی از زمانها</label><br/>
                        <input class="page-next"  type="radio" id="vehicle20_2" name="vehicle20" value="3" required>
                        <label for="vehicle20_2"> بیشتر زمانها</label><br>
                        <input class="page-next"  type="radio" id="vehicle20_1" name="vehicle20" value="4" required>
                        <label for="vehicle20_1"> همه زمانها</label><br>
                        <div class="col-12 text-center mt-3">
                            <button type="button" class="page-prev btn btn-danger col-3 ">قبلی</button>
                            <button type="button" class="page-next btn btn-primary col-3">بعدی</button>
                        </div>
