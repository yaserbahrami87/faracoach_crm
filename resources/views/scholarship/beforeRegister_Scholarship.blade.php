    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-8 text-center">
                ...
                <hr/>
                <h3 class="d-block text-dark" style="line-height: 2">طرح اعطای بورسیه تحصیلی آکادمی بین المللی فراکوچ</h3>
                <u style="line-height: 2">شناسایی و دعوت از افراد نخبه و با استعداد جهت حضور ویژه</u>
                <p style="line-height: 2;text-align: justify">ما عمیقا باور داریم که کوچینگ، مسیری روشن را برای همه افراد موفق جامعه که در پی رشد و توسعه شخصی و کسب و کار هستند باز می کند.
                    در این راستا آکادمی بین المللی فراکوچ فرصت بی نظیری را در جهت ورود به اکوسیستم کوچینگ برای تمام افراد مستعد، نخبه و توانمند جامعه به ویژه اساتید، پژوهشگران، اندیشمندان، مدیران و دانشجویان برتر تحت عنوان طرح اعطای بورسیه آموزش تخصصی مهارتهای کوچینگ و تربیت کوچ معتبر فراهم کرده است.
                    جهت انجام مشاوره و دریافت اطلاعات لازم لطفا فرم را تکمیل نمائید تا همکاران ما در اسرع وقت با شما تماس بگیرند. </p>
                <h5 class="text-dark mb-3">ما شما را به این کمپین دعوت می کنیم</h5>
