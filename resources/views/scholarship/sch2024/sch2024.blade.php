            ...
            <div class="col-md-8 text-center">
                ...
                <div class="col-md-8 m-auto">
                    <span class="text-center m-auto" style="color: #2c4059">
                        ...
                        <p> برای اطمینان همین الان عدد 12 را به سرشماره <mark>100010009020</mark> ارسال کن ! </p>
                        <p>فارسی زبانان خارج از کشور و همچنین کسانی که در دریافت کد مشکلی دارند، کد خود را در بالای صفحه بعدی مشاهده میکنند . </p>
                        <p>پشتیبانی و روابط عمومی : <mark>09197060068</mark>تماس -واتساپ - تلگرام (FC_PR@) </p>
                    </span>
                    <span>

                        <p> <i class="bi bi-exclamation-circle" style="color:#ea5455 ;font-size: 18px"></i> چنانچه تاکنون با شرایط بورسیه آشنا نشدید و نیاز به اطلاعات اولیه دارید ، <br> وارد صفحه زیر شوید : </p>
                        <a href="https://yasermotahedin.com/sch2024">yasermotahedin.com/sch2024</a>
                    </span>
                </div>
            </div>
        </div>
