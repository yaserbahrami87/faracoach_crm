...
return [
    ...
    */
    ...
    'mimes'                => ':attribute فرمت‌های معتبر فایل عبارتند از: :values.',
    ...
    */
    ...
    'attributes' => [
        ...
        'job'                   =>'شغل',
        'state'                 =>'استان',
        'personal_image'        =>'عکس شخصی',
        'shenasnameh_image'     =>'عکس شناسنامه',
        'cartmelli_image'       =>'عکس کارت ملی',
        'education_image'       =>'عکس مدرک تحصیلی',
        'resume'                =>'رزومه',
        'gettingknow'           =>'نحوه آشنایی',
        'introduced'            =>'معرف',
        'telegram'              =>'تلگرام',
        ...
        'skills'                =>'مهارت ها',
        'count_meeting'         =>'تعداد جلسات',
        'customer_satisfaction' =>'تعداد رضایت مشتری',
        'change_customer'       =>'تعداد مشتری',
        'count_recommendation'  =>'تعداد توصیه نامه',
        'shortlink'             =>'شورت لینک',
        'status'                =>'وضعیت',
